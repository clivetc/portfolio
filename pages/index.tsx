	...
	return (
		<>
			<Head>
				...
				<meta name="title" content="Tendai Clive Chikwape | Full Stack Software Engineer | React, TypeScript, Node.js Developer" />
				<meta 
					name="description" 
				...
				<meta property="og:title" content="Tendai Clive Chikwape | Full Stack Software Engineer" />
				<meta property="og:description" content="Experienced Full Stack Software Engineer specializing in React, Next.js, TypeScript, Node.js, NestJS, and SpringBoot. Building scalable web applications." />
				...
				<meta property="twitter:title" content="Tendai Clive Chikwape | Full Stack Software Engineer" />
				<meta property="twitter:description" content="Experienced Full Stack Software Engineer specializing in React, Next.js, TypeScript, Node.js, NestJS, and SpringBoot." />
				...
				<script
					...
					dangerouslySetInnerHTML={{
						__html: JSON.stringify({
							...
							"description": "Experienced Full Stack Software Engineer specializing in React, Next.js, TypeScript, Node.js, NestJS, and SpringBoot",
							"sameAs": [
