...
const data = {
  ...
  title: "Front-End Developer/Automation Developer",
  social: {
  ...
  projects: [
    ...
    {
      title: "Old Portfolio",
      description: "⚡ The portfolio was built with HTML5, JavaScript and CSS3.",
      tags: [
        "website",
        "portfolio",
        "HTML5",
    ...
    },
    {
      ...
      description:"🧑‍💻 For my graduation project we developed a online learning system",
      tags:[
        "website",
        "graduation project",
        "vue.js",
